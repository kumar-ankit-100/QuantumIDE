            ...
            <div className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a
                    ...
                    className="text-xs text-zinc-400 hover:text-zinc-300 transition-colors underline-offset-4 hover:underline"
                  >
                    Forgot password?
                  </a>
                </div>
              ...
              >
                {isLoading ? (
                  ...
                  <span className="flex items-center justify-center">
                    Sign in
                    <LogIn className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
                  </span>
                )}
              </Button>
            </div>
